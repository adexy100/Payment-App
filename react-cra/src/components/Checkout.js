    ...
    <div className="sr-root">
      <div className="sr-main">
        <header className="sr-header">
          <div className="sr-header__logo"><img src={Logo} alt="Ademola" /></div>
        </header>
        <section className="container">
          <div>
            ...
            <div className="pasha-image">
              <img
                ...
                src="https://www.macmillandictionaryblog.com/wp-content/uploads/2017/07/emoji-810x514.jpg"
                width="140"
                height="160"
              />
            </div>
          ...
          <p className="sr-legal-text">Buy me more (max 10)</p>
